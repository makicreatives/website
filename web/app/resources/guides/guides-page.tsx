...
export default function GuidesPage() {
    ...
    const getGuideCard = function (guide: Guide, index: number): JSX.Element {
        return <Link href={slugToUrl(guide.slug)} key={"featuredGuide" + index} id={guide.slug} className={"flex flex-col justify-between p-8 border-b md:border-r md:border-b border-black dark:border-off-white  hover:text-white bg-offWhite1B hover:bg-primary0 hover:shadow-md hover:shadow-primary0-400 transition-all duration-300 h-full"}>
