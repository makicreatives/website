    ...
    return <section id="process" className={""}>
        <div className="border-y border-y-black dark:border-y-off-white  mb-4 md:mb-8 ">
            <div className="grid grid-cols-1 md:grid-cols-2 ">
                <h2 className="h2 font-display  text-display-medium md:text-5xl leading-tight p-8 border-r border-r-black dark:border-r-off-white">A clear process. <br /> A result you&apos;ll love</h2>
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-t border-t-black dark:border-t-off-white">
                <div className="border-r border-r-black dark:border-r-off-white">
                    ...
                    <div className={"relative h-96  border-y border-y-black dark:border-y-off-white duration-1000 ease-in-out hover:bg-radial-[at_25%_25%] hover:from-[#D4AF37]/30 hover:via-[#C8A2FF]/40 hover:to-black/80"}>
                ...
                <div className="border-r border-r-black dark:border-r-off-white">
                    <div className="p-8 h-8"></div>
                    <div className={"relative h-96  border-y border-y-black dark:border-y-off-white duration-1000 ease-in-out hover:bg-radial-[at_25%_25%] hover:from-[#D4AF37]/30 hover:via-[#C8A2FF]/40 hover:to-black/80"}>
                        <Image src={"/images/site/handshake.png"} alt={"handshake neon sign"} layout="fill" className="bg-gray-300 bg-opacity-0 mix-blend-luminosity object-cover"></Image>
                    </div>
                    <div className="p-8">
