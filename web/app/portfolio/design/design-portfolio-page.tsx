        ...
        <div className="flex-1">
          <div className="md:hidden w-full inline-flex flex-nowrap overflow-hidden">
            <div className="flex items-center justify-center md:justify-start animate-infinite-scroll md:animate-none">
              <p className="font-display text-display-large m-auto md:-rotate-90 text-nowrap capitalize">Our Design </p>
              ...
              <div className=" py-1 min-w-[25vw]">
                ...
                <form >
                  ...
                  <div className="relative">
                    ...
                    <input type="search" id="search" className="block w-full p-2.5 ps-10 text-technical-medium font-technical text-gray-900 border border-primary0/50 bg-off-white1B focus:ring-primary1B focus:border-primary1B dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary1B dark:focus:border-primary1B" placeholder="Search project" required />
